            ...
            <div className="flex flex-col overflow-y-auto bg-slate-200 flex-1 p-6">                
                <div className="flex justify-between items-center p-3 bg-slate-200 rounded-lg mb-5">                    
                    <div className='flex gap-0 bg-white pl-2 rounded-md w-full max-[1000px]:w-6/12 max-[700px]:w-4/12'>                        
                        ...
                        <input 
                            ...
                            className="outline-none placeholder:text-slate-500 border-gray-300 p-2 border-0 rounded-r-md max-[1000px]:w-full w-6/12" 
                        />                    
                    </div>                    
                ...
                <div className="flex justify-between items-center mb-4">                    
                    <div className="flex gap-4">                        
                        <select 
                            onChange={handle_cohort} 
                            className="font-bold px-1 bg-slate-300 border-0 border-gray-300 p-2 rounded-lg"
                        >                            
                        ...
                        <select 
                            ...
                            className="border-0 bg-slate-300 font-bold px-1 border-gray-300 p-2 rounded-lg"
                        >                            
                    ...
                    <button 
                        ...
                        className="bg-gray-500 max-[600px]:text-sm max-[600px]:px-1 text-white px-4 py-2 rounded-lg"
                    >
                        + Add new Student
                    </button>                
                </div>                 
